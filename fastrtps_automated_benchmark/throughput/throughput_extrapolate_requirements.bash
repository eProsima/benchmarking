...
{
    echo "------------------------------------------------------------------------"
    echo "Script run Fast-RTPS throughput experiments."
    echo ""
    echo "Run a certain number of throughput experiments using 'throughput_run_experiment.bash',"
    echo "process their results with 'throughput_process_results.py', and create a requirements CSV"
    echo "file with 'throughput_determine_requirements.py'"
    echo "------------------------------------------------------------------------"
    ...
    echo ""
    echo "EXAMPLE: bash throughput_extrapolate_requirements.bash \\"
    echo "             -c <colcon_ws> \\"
    echo "             -r <some_dir> \\"
    echo "             -n <number> \\"
...
main ()
{
    ...
    ${PYTHON_3} ${SCRITP_DIR}/throughput_determine_requirements.py \
